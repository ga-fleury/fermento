...
window.draw = function draw() {
  ...
  angleMode(DEGREES);
  noFill();
  var a = round(random(0, 36)) * 10;
  var b = round(random(0, 36)) * 10;
  var c = round(random(0, 36)) * 10;
  var d = round(random(0, 36)) * 10;
  var e = round(random(0, 36)) * 10;
  var f = round(random(0, 36)) * 10;
  var g = round(random(0, 36)) * 10;
  var h = round(random(0, 36)) * 10; // remove elementos da array colors até só sobrarem 4

  for (var i = 0; i < 2; i++) {
    var colorPicker = round(random(0, colors.length - 1));
  ...
  arc(0, 0, 110, 110, 0, 90); //fill

  strokeWeight(24);
  arc(0, 0, 140, 140, 0, 90); //caps
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","fermento.js"], null)